\section{Abridged Derivation of the EM Algorithm for Gaussian Mixture Models}
...
%
\footnote{Parameters for $k=0$ can be found via the {\it k}-means algorithm~\cite{Duda01, Linde80} (see also Section \ref{sec:initial_estimate}).}
%
~$\Theta^{[k]}$,
