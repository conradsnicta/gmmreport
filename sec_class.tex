...
as part of recent releases of the open source Armadillo C++ linear algebra library%
\footnote{The Armadillo C++ linear algebra library can be obtained from \href{http://arma.sourceforge.net}{http://arma.sourceforge.net}}%
~\cite{Armadillo_JOSS_2016,Armadillo_PASC_2017}.
