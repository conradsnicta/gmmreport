...
and the {\it k}-means algorithm~\cite{Bishop_2006,Duda01,Linde80} which is typically used for providing the initial estimate of $\lambda$ for the EM algorithm.
...
we have provided a readily accessible, user friendly and open source implementation of multi-threaded (parallelised) versions 
of the {\it k}-means and EM algorithms.
The implementation is provided under the permissive Apache~2.0 license, 
...
along with approaches for improving convergence and modelling accuracy.
